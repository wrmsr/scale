        ...
        extends CompoundAssignmentOp
{
     ...
     */
    public RemainderAssignmentOp(Type type, Type calcType, Expression lhs, Expression ra)
    {
        super(type, calcType, lhs, ra);
    }

    public RemainderAssignmentOp(Type type, Expression lhs, Expression ra)
    {
    ...
    {
        p.visitRemainderAssignmentOp(this);
    }
}
