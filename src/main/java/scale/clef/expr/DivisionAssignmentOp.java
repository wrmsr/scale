 ...
 * <p/>
 * $Id: DivisionAssignmentOp.java,v 1.26 2006-12-18 21:36:49 burrill Exp $
 * <p/>
...
public class DivisionAssignmentOp
        extends CompoundAssignmentOp
{
     ...
     */
    public DivisionAssignmentOp(Type type, Type calcType, Expression lhs, Expression ra)
    {
        super(type, calcType, lhs, ra);
    }

    public DivisionAssignmentOp(Type type, Expression lhs, Expression ra)
    {
    ...
    {
        p.visitDivisionAssignmentOp(this);
    }
}
