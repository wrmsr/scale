 ...
 * <p/>
 * $Id: BitOrAssignmentOp.java,v 1.24 2006-12-18 21:36:48 burrill Exp $
 * <p/>
...
public class BitOrAssignmentOp
        extends CompoundAssignmentOp
{
     ...
     */
    public BitOrAssignmentOp(Type type, Type calcType, Expression lhs, Expression ra)
    {
        super(type, calcType, lhs, ra);
    }

    public BitOrAssignmentOp(Type type, Expression lhs, Expression ra)
    {
