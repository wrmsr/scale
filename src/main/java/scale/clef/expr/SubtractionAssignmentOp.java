 ...
 * <p/>
 * $Id: SubtractionAssignmentOp.java,v 1.26 2006-12-18 21:36:49 burrill Exp $
 * <p/>
...
public class SubtractionAssignmentOp
        extends CompoundAssignmentOp
{
     ...
     */
    public SubtractionAssignmentOp(Type type, Type calcType, Expression lhs, Expression ra)
    {
        super(type, calcType, lhs, ra);
    }

    public SubtractionAssignmentOp(Type type, Expression lhs, Expression ra)
    {
    ...
    {
        p.visitSubtractionAssignmentOp(this);
    }
}
