 ...
 * <p/>
 * $Id: BitAndAssignmentOp.java,v 1.24 2006-12-18 21:36:48 burrill Exp $
 * <p/>
...
public class BitAndAssignmentOp
        extends CompoundAssignmentOp
{
     ...
     */
    public BitAndAssignmentOp(Type type, Type calcType, Expression lhs, Expression ra)
    {
        super(type, calcType, lhs, ra);
    }

    public BitAndAssignmentOp(Type type, Expression lhs, Expression ra)
    {
    ...
    {
        p.visitBitAndAssignmentOp(this);
    }
}
