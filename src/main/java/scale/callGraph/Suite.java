        ...
        extends Root
{
     ...
     */
    private class CGDIterator
            implements Iterator<Declaration>
    {
     ...
     */
    private class CGRIterator
            implements Iterator<RoutineDecl>
    {
        private int property;     // property
        private Enumeration<CallGraph> ecg;          // current call graph
     ...
     */
    private static class ExternDeclEnumeration
            implements Enumeration<Declaration>
    {
