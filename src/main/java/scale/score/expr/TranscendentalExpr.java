        ...
        extends UnaryExpr
{
    ...
    public Literal getConstantValue(HashMap<Expr, Literal> cvMap)
    {
        ...
        switch (ftn) {
            case Sqrt:
                r = Lattice.sqrt(type, la);
                break;
            case Exp:
                r = Lattice.exp(type, la);
                break;
            case Log:
                r = Lattice.log(type, la);
                break;
            case Log10:
                r = Lattice.log10(type, la);
                break;
            case Sin:
                r = Lattice.sin(type, la);
                break;
            case Cos:
                r = Lattice.cos(type, la);
                break;
            case Tan:
                r = Lattice.tan(type, la);
                break;
            case Asin:
                r = Lattice.asin(type, la);
                break;
            case Acos:
                r = Lattice.acos(type, la);
                break;
            case Atan:
                r = Lattice.atan(type, la);
                break;
            case Sinh:
                r = Lattice.sinh(type, la);
                break;
            case Cosh:
                r = Lattice.cosh(type, la);
                break;
            case Tanh:
                r = Lattice.tanh(type, la);
                break;
            case Conjg:
                r = Lattice.conjg(type, la);
                break;
            default:
                r = Lattice.Bot;
                break;
    ...
    public Literal getConstantValue()
    {
        ...
        switch (ftn) {
            case Sqrt:
                return Lattice.sqrt(type, la);
            case Exp:
                return Lattice.exp(type, la);
            case Log:
                return Lattice.log(type, la);
            case Log10:
                return Lattice.log10(type, la);
            case Sin:
                return Lattice.sin(type, la);
            case Cos:
                return Lattice.cos(type, la);
            case Tan:
                return Lattice.tan(type, la);
            case Asin:
                return Lattice.asin(type, la);
            case Acos:
                return Lattice.acos(type, la);
            case Atan:
                return Lattice.atan(type, la);
            case Sinh:
                return Lattice.sinh(type, la);
            case Cosh:
                return Lattice.cosh(type, la);
            case Tanh:
                return Lattice.tanh(type, la);
            case Conjg:
                return Lattice.conjg(type, la);
            default:
                return Lattice.Bot;
        }
    }
