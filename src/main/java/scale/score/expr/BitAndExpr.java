 ...
 * <p/>
 * $Id: BitAndExpr.java,v 1.27 2007-04-27 18:04:35 burrill Exp $
 * <p/>
...
public class BitAndExpr
        extends BinaryExpr
{
    public BitAndExpr(Type t, Expr e1, Expr e2)
    {
        super(t, e1, e2);
    }
     ...
     */
    public BitAndExpr(Expr e1, Expr e2)
    {
        this(e1.getType(), e1, e2);
    }

    /**
     * This method of creating a BitAndExpr instance will return a
    ...
    public static Expr create(Type type, Expr la, Expr ra)
    {
        ...
        return new BitAndExpr(type, la, ra);
    }

    public Expr copy()
    {
        return new BitAndExpr(getType(), getLeftArg().copy(), getRightArg().copy());
    }

    public void visit(Predicate p)
    {
        p.visitBitAndExpr(this);
    }
    ...
    public Literal getConstantValue(HashMap<Expr, Literal> cvMap)
    {
        ...
        r = Lattice.bitAnd(getCoreType(), la, ra);
    ...
    public Literal getConstantValue()
    {
        ...
        return Lattice.bitAnd(getCoreType(), la, ra);
    }
}
