 ...
 * FreeVarDecl.
 * <p/>
 * $Id: FreeVarDecl.java,v 1.7 2005-02-07 21:28:40 burrill Exp $
 * <p/>
 ...
 * </blockquote>
 */
public class FreeVarDecl
        extends GlobalVarDecl
{
    int arity;

    public FreeVarDecl(String name, int arity)
    {
        super(name);
        this.arity = arity;
    }
    ...
    {
        StringBuffer buf = new StringBuffer("(FreeVarDecl 0x");
