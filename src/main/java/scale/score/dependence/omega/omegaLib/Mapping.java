...
public final class Mapping
{
    ...
    public Mapping(Mapping m)
    {
        ...
        this.map_in_kind = m.map_in_kind.clone();
        this.map_in_pos = m.map_in_pos.clone();
        this.map_out_kind = m.map_out_kind.clone();
        this.map_out_pos = m.map_out_pos.clone();
    }
    ...
    public void setMap(int in_kind, int pos, int type, int map)
    {
        if (in_kind == VarDecl.INPUT_VAR) {
            ...
            throw new scale.common.InternalError("setMap");
        }
    }
    ...
    public void setMap_in(int pos, int type, int map)
    {
        if ((pos < 1) || (pos > n_input)) {
            throw new scale.common.InternalError("Mapping: setMap_in " + pos + " " + (n_input - 1));
        }
    ...
    {
        if ((pos < 1) || (pos > n_input)) {
            throw new scale.common.InternalError("Mapping: setMap_set");
        }
        map_in_kind[pos] = type;
        map_in_pos[pos] = map;
    }
    ...
    public void setMap_out(int pos, int type, int map)
    {
        if ((pos < 1) || (pos > n_output)) {
            throw new scale.common.InternalError("Mapping: setMap_out");
        }
    ...
    {
        if ((pos < 1) || (pos > n_input)) {
            throw new scale.common.InternalError("Mapping: getMapInKind");
        }
    ...
    {
        if ((pos < 1) || (pos > n_input)) {
            throw new scale.common.InternalError("Mapping: getMapInPos");
        }
    ...
    {
        if ((pos < 1) || (pos > n_output)) {
            throw new scale.common.InternalError("Mapping: getMapOutKind");
        }
    ...
    {
        if ((pos < 1) || (pos > n_output)) {
            throw new scale.common.InternalError("Mapping: getMapOutPos");
        }
    ...
    public int getInputFate(int prefix)
    {
        ...
        if (n_input < prefix) {
            throw new scale.common.InternalError("Mapping: getInputFate: " + n_output + " < " + prefix);
        }
        ...
        switch (vf) {
            case VarDecl.INPUT_VAR:
                return VarDecl.INPUT_TUPLE;
            case VarDecl.SET_VAR:
                return VarDecl.SET_TUPLE;
            case VarDecl.OUTPUT_VAR:
                return VarDecl.OUTPUT_TUPLE;
            default:
                return VarDecl.UNKNOWN_TUPLE;
        }
    }
    ...
    public int getOutputFate(int prefix /* = -1 */)
    {
        ...
        if (n_output < prefix) {
            throw new scale.common.InternalError("Mapping: getOutputFate");
        }
