 ...
 * FDeclaration.
 * <p/>
 * $Id: FDeclaration.java,v 1.12 2005-02-07 21:28:39 burrill Exp $
 * <p/>
 ...
 * </blockquote>
 */
public abstract class FDeclaration
        extends Formula
{
    ...
    {
        super(omegaLib, f, r);
        myLocals = new Vector<VarDecl>();
    }

    public FDeclaration(OmegaLib omegaLib, Formula f, RelBody r, Vector<VarDecl> vid)
    {
        super(omegaLib, f, r);
        myLocals = new Vector<VarDecl>(vid.size());
        for (VarDecl vd : vid) {
            myLocals.add(vd);
        }
    }
    ...
    public Vector<VarDecl> declareTuple(int size)
    {
        ...
        Vector<VarDecl> n = new Vector<VarDecl>();
    ...
    public void setupNames()
    {
        ...
        for (int i = 0; i < l; i++) {
            omegaLib.decrement(myLocals.elementAt(i));
        }
    }
