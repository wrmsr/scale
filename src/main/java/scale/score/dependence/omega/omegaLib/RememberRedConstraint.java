 ...
 * <p/>
 * $Id: RememberRedConstraint.java,v 1.7 2005-02-07 21:28:41 burrill Exp $
 * <p/>
...
public final class RememberRedConstraint
{
    ...
    public void recall(Problem p, int[] forwardingAddress, int[] varr)
    {
        ...
        switch (kind) {
            ...
            case notRed:
            case redLEQ:
                throw new scale.common.InternalError("recall");
            case redGEQ:
                e = p.getNewGEQ();
                e.setTouched(true);
                break;
        ...
        for (int i = 1; i < length; i++) {
            ...
            if (varr[f] != v) {
                throw new scale.common.InternalError("recall variable error");
            }
            e.setCoef(f, coef[i]);
        }
    }
