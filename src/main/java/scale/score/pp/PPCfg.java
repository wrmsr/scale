        ...
        implements java.lang.Comparable<PPCfg>
{
    ...
    */
     ...
     * Ball-Larus paper.
     */
    private void countPaths(final PPBlock v, long truncationThreshold)
            throws TooManyPathsException
    {
     ...
     * exceeds a threshold.
     */
    private static class TooManyPathsException
...
*/
    ...
    private static class FBPair
            implements java.lang.Comparable<FBPair>
    {
        ...
        {
            switch (metric) {
                case PPCfg.RAW_METRIC:
                    return flow;
                case PPCfg.BRANCH_METRIC:
                    return flow * numBranches;
            }
