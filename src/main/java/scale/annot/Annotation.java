        ...
        implements DisplayNode
{
     ...
     * @throws NoSuchElementException tried to delete a node which is
     * not associated with this annotation.
     */
    public static final void removeNode(AnnotationInterface n, Object key)
            ...
            if (na instanceof Annotation) {
                ...
                switch (count) {
                    case 0:
                        return new EmptyEnumeration<Annotation>();
                    case 1:
                        return new SingleEnumeration<Annotation>((Annotation) o2);
                    case 2:
                        return new DoubleEnumeration<Annotation>((Annotation) o1, (Annotation) o2);
                    default:
                        break;
                }
