...
public class Scale
{
     ...
     */
    private void optimizeAllCFGs(Suite suite)
            throws java.lang.Exception
    {
     ...
     */
    protected void genCfromClef(CallGraph cg, String name)
            throws java.lang.Exception
    {
        if (cg == null) {
            return;
    ...
    private static void processCommandOutput(Process p)
            throws java.lang.Exception
    {
     ...
     * @return true if the command failed
     */
    protected boolean executeCommand(Vector<String> command)
            throws java.lang.Exception
    {
        int l = command.size();
