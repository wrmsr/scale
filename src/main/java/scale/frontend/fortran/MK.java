...
public final class MK
{
    ...
    private void writeKeyword(String keyword, Writer wr, int k)
            throws IOException
    {
        buf.setLength(0);
    ...
    private void writeKeywords(Writer wr, int numKeywords)
            throws IOException
    {
    ...
    private void writeBitArrays(Writer wr, int numKeywords)
            throws IOException
    {
    ...
    private void writeIsFtns(Writer wr)
            throws IOException
    {
        Enumeration<String> et = attrAMap.keys();
        while (et.hasMoreElements()) {
    ...
    private void writeMinMax(Writer wr, int k)
            throws IOException
    {
    ...
    private void writeLookup(Writer wr)
            throws IOException
    {
