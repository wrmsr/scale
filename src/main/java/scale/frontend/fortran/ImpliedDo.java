...
public class ImpliedDo
{
    ...
    private Literal fixData(Type type, Expression data)
            throws InvalidException
    {
    ...
    private void addElement(VariableDecl vd, long offset, Literal data, int indent)
            throws InvalidException
    {
        Expression values = vd.getValue();
     ...
     * @see F95#callback
     */
    public DoLoopStmt genImpliedDoLoop(int callback, F95 f95)
            throws InvalidException
    {
    ...
    private int getExpValue(Expression exp)
            throws InvalidException
    {
