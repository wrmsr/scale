...
public final class EquivSet
{
     ...
     * instance.
     */
    public void update(VariableDecl decl, EquivalenceDecl ev)
     ...
     */
    public void addEntry(VariableDecl decl, long offset)
            throws InvalidException
    {
    ...
    private void merge(EquivSet old, int newIndex, int oldIndex)
            throws InvalidException
    {
