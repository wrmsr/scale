...
public class C99Lexer
        ...
        implements C99ParserTokenTypes, TokenStream
{
            ...
            switch (LA(1)) {
                ...
                case 'x': {
                    ...
                    if (inputState.guessing == 0) {
                        ...
                        x = ((char) Integer.parseInt(str.substring(2), 16));
                        text.setLength(_begin);
                        text.append(x);
                    }
                    break;
                ...
                case '7': {
                    ...
                    if (inputState.guessing == 0) {
                        ...
                        String str = new String(text.getBuffer(), _begin, text.length() - _begin);
                        x = (char) Integer.parseInt(str.substring(1), 8);
                        text.setLength(_begin);
                        text.append(x);
                    }
                    break;
