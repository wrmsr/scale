    ...
    private Type buildType(int baseType, Type buildType)
    {
        ...
        switch (baseType) {
            ...
            case cSignedChar:
                ...
                break;
            case cUnsignedChar:
                bt = unsigned_char_type;
                break;
            case cUnsignedShort:
                bt = unsigned_short_type;
                break;
            case cUnsigned:
                bt = unsigned_int_type;
                break;
            case cUnsignedInt:
                bt = unsigned_int_type;
                break;
            case cUnsignedLong:
                bt = unsigned_long_type;
                break;
            case cUnsignedLongLong:
                bt = unsigned_long_long_type;
                break;
            case cFloat:
                bt = float_type;
                break;
            ...
            case cBool:
                ...
                break;
            case cComplex:
                bt = double_complex_type;
                break;
            case cImaginary:
                bt = double_imaginary_type;
                break;
            case cFloatComplex:
                bt = float_complex_type;
                break;
            case cFloatImaginary:
                bt = float_imaginary_type;
                break;
            case cDoubleComplex:
                bt = double_complex_type;
                break;
            case cDoubleImaginary:
                bt = double_imaginary_type;
                break;
            case cVoid:
                bt = void_type;
        ...
        if (rd != null) {
            ...
            switch (storageClass & SC_MASK) {
                ...
                case cExtern:
                    ...
                    return;
                case cStatic:
                    rd.setVisibility(Visibility.FILE);
                    return;
                case cGlobal:
...
//    System.out.println("** sbt " + typeNames[baseType] + " " + typeNames[type] + " -> " + typeNames[typeFSA[baseType][type]]);
    ...
    private Type charToType(char c)
    {
        switch (c) {
            ...
            case 'C':
                return charp_type;
            case 'H':
                return PointerType.create(RefType.create(char_type, RefAttr.Const));
            default:
    ...
    private boolean setAlias(String attribute, Declaration decl)
    {
        ...
        while ((i < l) && Character.isWhitespace(attribute.charAt(i))) {
            i++;
        }
    ...
    private Expression buildAssignment(int op, Expression la, Expression ra, Token t)
    {
        ...
        switch (calcRType[op]) {
            ...
            case LEFT:
                ...
                break;
            case BOTH:
                rtype = calcBinaryType(latype, ratype);
                break;
        }
        ...
        switch (op) {
            case 1:
                return new AssignSimpleOp(latype, lhs, rhs);
            case 2:
                return new MultiplicationAssignmentOp(latype, rtype, lhs, rhs);
            case 3:
                return new DivisionAssignmentOp(latype, rtype, lhs, rhs);
            case 4:
                return new RemainderAssignmentOp(latype, rtype, lhs, rhs);
            case 5:
                return new AdditionAssignmentOp(latype, rtype, lhs, rhs);
            case 6:
                return new SubtractionAssignmentOp(latype, rtype, lhs, rhs);
            case 7:
                return new BitAndAssignmentOp(latype, rtype, lhs, rhs);
            case 8:
                return new BitOrAssignmentOp(latype, rtype, lhs, rhs);
            case 9:
                return new BitXorAssignmentOp(latype, rtype, lhs, rhs);
            case 10:
                return new BitShiftAssignmentOp(latype, rtype, lhs, rhs, ShiftMode.Left);
            case 11:
                return new BitShiftAssignmentOp(latype, rtype, lhs, rhs, t1.isSigned() ? ShiftMode.SignedRight : ShiftMode.UnsignedRight);
        }
    ...
    private Expression buildCompare(int sw, Expression la, Expression ra, Token t)
    {
        ...
        switch (sw) {
            case 1:
                return new LessOp(bool_type, la, ra);
            case 2:
                return new GreaterOp(bool_type, la, ra);
            case 3:
                return new LessEqualOp(bool_type, la, ra);
            case 4:
                return new GreaterEqualOp(bool_type, la, ra);
        }
        return userExprError(Msg.MSG_Operands_to_s_not_compatible, t.getText(), la, ra, t);
    }
        ...
        try {      // for error handling
            {
                switch (LA(1)) {
                    case LBrace: {
                        ...
                        v = initializerList(type);
                        if (inputState.guessing == 0) {
                            expr = buildAggregation(type, v, LT(1));
                            inConstant = sic;
                        }
                        break;
                    }
    ...
    protected final Vector<String> identifierList()
            throws RecognitionException, TokenStreamException
    {
    ...
    protected final Vector<Object> designation()
            throws RecognitionException, TokenStreamException
    {
        Vector<Object> positions = null;
