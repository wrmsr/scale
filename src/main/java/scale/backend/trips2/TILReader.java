...
public class TILReader
{
     ...
     */
    private void parseBlock(StreamTokenizer st)
    ...
    private void requireWord(StreamTokenizer st)
            throws java.lang.Exception
    {
    ...
    private void requireComma(StreamTokenizer st)
            throws java.lang.Exception
    {
        if (st.ttype != ',') {
    ...
    private void requireAngBracket(StreamTokenizer st)
            throws java.lang.Exception
    {
        if (st.ttype != '<') {
            throw new java.lang.Exception("Expecting a '<' at line number: " + st.lineno());
    ...
    private void requireCommaOrBracket(StreamTokenizer st)
            throws java.lang.Exception
    {
    ...
    private void ignoreEOL(StreamTokenizer st)
            throws java.lang.Exception
    {
