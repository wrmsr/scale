 ...
 * <p/>
 * $Id: StorexInstruction.java,v 1.5 2006-11-09 00:56:06 burrill Exp $
 * <p/>
...
public class StorexInstruction
        extends StoreInstruction
{
     ...
     * @param rd is the source register
     * @param ra is the address register
     * @param rb is the other source register
     */
    public StorexInstruction(int opcode, int rd, int ra, int rb)
    {
        super(opcode, rd, ra);
        this.rb = rb;
    }
