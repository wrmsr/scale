 ...
 * <p/>
 * $Id: Inst7Instruction.java,v 1.20 2005-03-24 13:56:53 burrill Exp $
 * <p/>
        ...
        extends SparcInstruction
{
    ...
    static {
        Statistics.register("scale.backend.sparc.Inst7Instruction", stats);
    }
    ...
    public Inst7Instruction(int opcode, int rs1, int rs2)
    {
        super(opcode);
        this.rs1 = rs1;
        this.rs2 = rs2;
