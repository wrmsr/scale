 ...
 * <p/>
 * $Id: WriteRegLitInstruction.java,v 1.22 2006-10-04 13:59:17 burrill Exp $
 * <p/>
...
public class WriteRegLitInstruction
        extends SparcInstruction
{
    ...
    static {
        Statistics.register("scale.backend.sparc.WriteRegLitInstruction", stats);
    }
    ...
    protected WriteRegLitInstruction(int opcode, int rs1, Displacement value, int dftn, int rd)
    {
        super(opcode);
        this.rd = rd;
        this.rs1 = rs1;
