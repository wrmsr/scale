 ...
 * <p/>
 * $Id: CondMovInstruction.java,v 1.13 2006-11-09 00:56:07 burrill Exp $
 * <p/>
...
public class CondMovInstruction
        extends MipsInstruction
{
    ...
    static {
        Statistics.register("scale.backend.mips.CondMovInstruction", stats);
    }
    ...
    public CondMovInstruction(int opcode, int ra, int rb, int rc)
    {
        super(opcode);
        createdCount++;
        this.opcode = opcode;
    ...
    {
        return (register == ra || register == rb || register == rc);
    }
