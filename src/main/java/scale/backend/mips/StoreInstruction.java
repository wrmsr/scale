 ...
 * <p/>
 * $Id: StoreInstruction.java,v 1.14 2006-11-09 00:56:08 burrill Exp $
 * <p/>
        ...
        extends MipsInstruction
{
    ...
    static {
        Statistics.register("scale.backend.mips.StoreInstruction", stats);
    }
    ...
    protected StoreInstruction(int opcode, int rd, int rs1, Displacement value, int dftn)
    {
        super(opcode);
        this.rd = rd;
        this.rs1 = rs1;
    ...
    protected StoreInstruction(int opcode, int rd, int rs1, Displacement value)
    {
    ...
    {
        return (register == rs1) || (register == rd);
    }
