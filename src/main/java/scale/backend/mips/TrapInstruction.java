 ...
 * <p/>
 * $Id: TrapInstruction.java,v 1.13 2006-11-09 00:56:08 burrill Exp $
 * <p/>
        ...
        extends MipsInstruction
{
    ...
    static {
        Statistics.register("scale.backend.mips.TrapInstruction", stats);
    }
    ...
    public TrapInstruction(int opcode, int ra, int rb)
    {
        super(opcode);
        createdCount++;
        this.opcode = opcode;
