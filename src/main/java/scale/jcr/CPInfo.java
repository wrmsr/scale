...
public abstract class CPInfo
{
            ...
            scale.common.InvalidException
    {
        ...
        switch (rtag) {
            case CONSTANT_Utf8:
                return Utf8CPInfo.read(cf, reader);
            case CONSTANT_Integer:
                return IntCPInfo.read(cf, reader);
            case CONSTANT_Float:
                return FloatCPInfo.read(cf, reader);
            case CONSTANT_Long:
                return LongCPInfo.read(cf, reader);
            case CONSTANT_Double:
                return DoubleCPInfo.read(cf, reader);
            case CONSTANT_Class:
                return ClassCPInfo.read(cf, reader);
            case CONSTANT_String:
                return StringCPInfo.read(cf, reader);
            case CONSTANT_Fieldref:
                return FieldRefCPInfo.read(cf, reader);
            case CONSTANT_Methodref:
                return MethodRefCPInfo.read(cf, reader);
            case CONSTANT_InterfaceMethodref:
                return InterfaceMethodRefCPInfo.read(cf, reader);
            case CONSTANT_NameAndType:
                return NameAndTypeCPInfo.read(cf, reader);
        }
