...
public class ScribbleGen
{
    ...
    private void iftest(int cmp, Expr ra, Expr la, int address, int pc)
    {
        ...
        switch (cmp) {
            case 0:
                op = new EqualityExpr(BooleanType.type, la, ra);
                break;
            case 1:
                op = new NotEqualExpr(BooleanType.type, la, ra);
                break;
            case 2:
                op = new LessExpr(BooleanType.type, la, ra);
                break;
            case 3:
                op = new GreaterEqualExpr(BooleanType.type, la, ra);
                break;
            case 4:
                op = new GreaterExpr(BooleanType.type, la, ra);
                break;
            case 5:
                op = new LessEqualExpr(BooleanType.type, la, ra);
                break;
        }
    ...
    private void processCode(int start, BitSet done)
    {
        ...
        while (bbIndex > 0) {
            ...
            while (!terminate) {
                ...
                pc++;
                switch (bc) {
                    case CodeAttribute.NOP:
                        break;
                    case CodeAttribute.ACONST_NULL:
                        pushConst(j2s.nil, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.ICONST_M1:
                        pushConst(j2s.intm1, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ICONST_0:
                        pushConst(j2s.int0, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ICONST_1:
                        pushConst(j2s.int1, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ICONST_2:
                        pushConst(j2s.int2, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ICONST_3:
                        pushConst(j2s.int3, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ICONST_4:
                        pushConst(j2s.int4, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ICONST_5:
                        pushConst(j2s.int5, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LCONST_0:
                        pushConst2(j2s.int0, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.LCONST_1:
                        pushConst2(j2s.int1, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FCONST_0:
                        pushConst(j2s.float0, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FCONST_1:
                        pushConst(j2s.float1, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FCONST_2:
                        pushConst(j2s.float2, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DCONST_0:
                        pushConst2(j2s.float0, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.DCONST_1:
                        pushConst2(j2s.float1, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.BIPUSH:
                        pushConst(j2s.getIntLiteral(ca.getByte(pc)), CodeAttribute.T_BYTE);
                        pc++;
                        break;
                    case CodeAttribute.SIPUSH:
                        pushConst(j2s.getIntLiteral(ca.getByte2(pc)), CodeAttribute.T_SHORT);
                        pc += 2;
                        break;
                    case CodeAttribute.LDC:
                        loadConst(ca.getIndex(pc));
                        pc++;
                        break;
                    case CodeAttribute.LDC_W:
                        loadConst(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.LDC2_W:
                        loadConst2(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.ILOAD:
                        load(ca.getIndex(pc), CodeAttribute.T_INT);
                        pc++;
                        break;
                    case CodeAttribute.LLOAD:
                        load2(ca.getIndex(pc), CodeAttribute.T_LONG);
                        pc++;
                        break;
                    case CodeAttribute.FLOAD:
                        load(ca.getIndex(pc), CodeAttribute.T_FLOAT);
                        pc++;
                        break;
                    case CodeAttribute.DLOAD:
                        load2(ca.getIndex(pc), CodeAttribute.T_DOUBLE);
                        pc++;
                        break;
                    case CodeAttribute.ALOAD:
                        load(ca.getIndex(pc));
                        pc++;
                        break;
                    case CodeAttribute.ILOAD_0:
                        load(0, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ILOAD_1:
                        load(1, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ILOAD_2:
                        load(2, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ILOAD_3:
                        load(3, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LLOAD_0:
                        load2(0, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.LLOAD_1:
                        load2(1, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.LLOAD_2:
                        load2(2, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.LLOAD_3:
                        load2(3, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FLOAD_0:
                        load(0, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FLOAD_1:
                        load(1, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FLOAD_2:
                        load(2, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FLOAD_3:
                        load(3, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DLOAD_0:
                        load2(0, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.DLOAD_1:
                        load2(1, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.DLOAD_2:
                        load2(2, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.DLOAD_3:
                        load2(3, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.ALOAD_0:
                        load(0, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.ALOAD_1:
                        load(1, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.ALOAD_2:
                        load(2, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.ALOAD_3:
                        load(3, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.IALOAD:
                        aload(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LALOAD:
                        aload2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FALOAD:
                        aload(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DALOAD:
                        aload2(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.AALOAD:
                        aload(CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.BALOAD:
                        aload(CodeAttribute.T_BYTE);
                        break;
                    case CodeAttribute.CALOAD:
                        aload(CodeAttribute.T_CHAR);
                        break;
                    case CodeAttribute.SALOAD:
                        aload(CodeAttribute.T_SHORT);
                        break;
                    case CodeAttribute.ISTORE:
                        store(ca.getIndex(pc), CodeAttribute.T_INT);
                        pc++;
                        break;
                    case CodeAttribute.LSTORE:
                        store2(ca.getIndex(pc), CodeAttribute.T_LONG);
                        pc++;
                        break;
                    case CodeAttribute.FSTORE:
                        store(ca.getIndex(pc), CodeAttribute.T_FLOAT);
                        pc++;
                        break;
                    case CodeAttribute.DSTORE:
                        store2(ca.getIndex(pc), CodeAttribute.T_DOUBLE);
                        pc++;
                        break;
                    case CodeAttribute.ASTORE:
                        store(ca.getIndex(pc));
                        pc++;
                        break;
                    case CodeAttribute.ISTORE_0:
                        store(0, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ISTORE_1:
                        store(1, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ISTORE_2:
                        store(2, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.ISTORE_3:
                        store(3, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LSTORE_0:
                        store2(0, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.LSTORE_1:
                        store2(1, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.LSTORE_2:
                        store2(2, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.LSTORE_3:
                        store2(3, CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FSTORE_0:
                        store(0, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FSTORE_1:
                        store(1, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FSTORE_2:
                        store(2, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FSTORE_3:
                        store(3, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DSTORE_0:
                        store2(0, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.DSTORE_1:
                        store2(1, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.DSTORE_2:
                        store2(2, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.DSTORE_3:
                        store2(3, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.ASTORE_0:
                        store(0, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.ASTORE_1:
                        store(1, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.ASTORE_2:
                        store(2, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.ASTORE_3:
                        store(3, CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.IASTORE:
                        astore(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LASTORE:
                        astore2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FASTORE:
                        astore(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DASTORE:
                        astore2(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.AASTORE:
                        astore(CodeAttribute.T_ADDRESS);
                        break;
                    case CodeAttribute.BASTORE:
                        astore(CodeAttribute.T_BYTE);
                        break;
                    case CodeAttribute.CASTORE:
                        astore(CodeAttribute.T_CHAR);
                        break;
                    case CodeAttribute.SASTORE:
                        astore(CodeAttribute.T_SHORT);
                        break;
                    case CodeAttribute.POP:
                        pop();
                        break;
                    case CodeAttribute.POP2:
                        pop2();
                        break;
                    case CodeAttribute.DUP:
                        dup();
                        break;
                    case CodeAttribute.DUP_X1:
                        dup_x1();
                        break;
                    case CodeAttribute.DUP_X2:
                        dup_x2();
                        break;
                    case CodeAttribute.DUP2:
                        dup2();
                        break;
                    case CodeAttribute.DUP2_X1:
                        dup2_x1();
                        break;
                    case CodeAttribute.DUP2_X2:
                        dup2_x2();
                        break;
                    case CodeAttribute.SWAP:
                        swap();
                        break;
                    case CodeAttribute.IADD:
                        add(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LADD:
                        add2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FADD:
                        add(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.DADD:
                        add2(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.ISUB:
                        sub(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LSUB:
                        sub2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FSUB:
                        sub(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DSUB:
                        sub2(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.IMUL:
                        mult(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LMUL:
                        mult2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FMUL:
                        mult(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DMUL:
                        mult2(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.IDIV:
                        divide(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LDIV:
                        divide2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FDIV:
                        divide(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DDIV:
                        divide2(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.IREM:
                        remainder(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LREM:
                        remainder2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FREM:
                        remainder(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DREM:
                        remainder2(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.INEG:
                        negate(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LNEG:
                        negate2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.FNEG:
                        negate(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DNEG:
                        negate2(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.ISHL:
                        lshift(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LSHL:
                        lshift2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.ISHR:
                        rshift(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LSHR:
                        rshift2(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.IUSHR:
                        urshift(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LUSHR:
                        urshift2(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.IAND:
                        and(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LAND:
                        and2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.IOR:
                        or(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LOR:
                        or2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.IXOR:
                        xor(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.LXOR:
                        xor2(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.IINC:
                        increment(ca.getIndex(pc), ca.getByte(pc + 1));
                        pc += 2;
                        break;
                    case CodeAttribute.I2L:
                        cast12(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.I2F:
                        cast11(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.I2D:
                        cast12(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.L2I:
                        cast21(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.L2F:
                        cast21(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.L2D:
                        cast22(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.F2I:
                        cast11(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.F2L:
                        cast12(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.F2D:
                        cast12(CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.D2I:
                        cast21(CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.D2L:
                        cast22(CodeAttribute.T_LONG);
                        break;
                    case CodeAttribute.D2F:
                        cast21(CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.I2B:
                        cast11(CodeAttribute.T_BYTE);
                        break;
                    case CodeAttribute.I2C:
                        cast11(CodeAttribute.T_CHAR);
                        break;
                    case CodeAttribute.I2S:
                        cast11(CodeAttribute.T_SHORT);
                        break;
                    case CodeAttribute.LCMP:
                        compare2(CompareExpr.Normal, CodeAttribute.T_INT);
                        break;
                    case CodeAttribute.FCMPL:
                        compare(CompareExpr.FloatL, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.FCMPG:
                        compare(CompareExpr.FloatG, CodeAttribute.T_FLOAT);
                        break;
                    case CodeAttribute.DCMPL:
                        compare2(CompareExpr.FloatL, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.DCMPG:
                        compare2(CompareExpr.FloatG, CodeAttribute.T_DOUBLE);
                        break;
                    case CodeAttribute.IFEQ:
                        iftest(0, new LiteralExpr(j2s.int0), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IFNE:
                        iftest(1, new LiteralExpr(j2s.int0), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IFLT:
                        iftest(2, new LiteralExpr(j2s.int0), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IFGE:
                        iftest(3, new LiteralExpr(j2s.int0), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IFGT:
                        iftest(4, new LiteralExpr(j2s.int0), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IFLE:
                        iftest(5, new LiteralExpr(j2s.int0), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IF_ICMPEQ:
                        iftest(0, pop(), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IF_ICMPNE:
                        iftest(1, pop(), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IF_ICMPLT:
                        iftest(2, pop(), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IF_ICMPGE:
                        iftest(3, pop(), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IF_ICMPGT:
                        iftest(4, pop(), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IF_ICMPLE:
                        iftest(5, pop(), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IF_ACMPEQ:
                        iftest(0, pop(), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IF_ACMPNE:
                        iftest(1, pop(), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IFNULL:
                        iftest(0, new LiteralExpr(j2s.nil), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.IFNONNULL:
                        iftest(1, new LiteralExpr(j2s.nil), pop(), ca.getByte2(pc), pc - 1);
                        pc += 2;
                        break;
                    case CodeAttribute.GOTO:
                        defineBranchPoint(exp.getEnd(), pc + ca.getByte2(pc) - 1, Boolean.TRUE);
                        terminate = true;
                        break;
                    case CodeAttribute.GOTO_W:
                        defineBranchPoint(exp.getEnd(), pc + ca.getIndex4(pc) - 1, Boolean.TRUE);
                        terminate = true;
                        break;
                    ...
                    case CodeAttribute.JSR_W:
                        ...
                        jsrFlag = true;
                        break; /* Inline it! */
                    case CodeAttribute.RET:
                        ca.getIndex(pc);
                        jsrIndex--;
                        pc = jsrStack[jsrIndex];
                        break;
                    case CodeAttribute.TABLESWITCH:
                        pc = tableSwitch(pc - 1);
                        break;
                    case CodeAttribute.LOOKUPSWITCH:
                        pc = lookupSwitch(pc - 1);
                        break;
                    case CodeAttribute.IRETURN:
                        doReturn(CodeAttribute.T_INT, pop());
                        terminate = true;
                        break;
                    case CodeAttribute.LRETURN:
                        doReturn(CodeAttribute.T_LONG, pop2());
                        terminate = true;
                        break;
                    case CodeAttribute.FRETURN:
                        doReturn(CodeAttribute.T_FLOAT, pop());
                        terminate = true;
                        break;
                    case CodeAttribute.DRETURN:
                        doReturn(CodeAttribute.T_DOUBLE, pop2());
                        terminate = true;
                        break;
                    case CodeAttribute.ARETURN:
                        doReturn(CodeAttribute.T_ADDRESS, pop());
                        terminate = true;
                        break;
                    case CodeAttribute.RETURN:
                        doReturn();
                        terminate = true;
                        break;
                    case CodeAttribute.GETSTATIC:
                        getStatic(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.PUTSTATIC:
                        putStatic(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.GETFIELD:
                        getField(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.PUTFIELD:
                        putField(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.INVOKEVIRTUAL:
                        invokeVirtual(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.INVOKESPECIAL:
                        invokeSpecial(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.INVOKESTATIC:
                        invokeStatic(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.INVOKEINTERFACE:
                        invokeInterface(ca.getIndex2(pc), ca.getByte(pc + 2));
                        pc += 4;
                        break;
                    case CodeAttribute.NEW:
                        doNew(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.NEWARRAY:
                        doNewarray(ca.getByte(pc));
                        pc++;
                        break;
                    case CodeAttribute.ANEWARRAY:
                        doANewarray(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.MULTIANEWARRAY:
                        multiANewarray(ca.getIndex2(pc), ca.getByte(pc + 2));
                        pc += 3;
                        break;
                    case CodeAttribute.ARRAYLENGTH:
                        arrayLength();
                        break;
                    case CodeAttribute.ATHROW:
                        athrow();
                        break;
                    case CodeAttribute.CHECKCAST:
                        checkCast(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.INSTANCEOF:
                        instanceOf(ca.getIndex2(pc));
                        pc += 2;
                        break;
                    case CodeAttribute.MONITORENTER:
                        monitorEnter();
                        break;
                    case CodeAttribute.MONITOREXIT:
                        monitorExit();
                        break;
                    ...
                    case CodeAttribute.WIDE:
                        ...
                        switch (bc) {
                            case CodeAttribute.IINC:
                                increment(ca.getIndex2(pc), ca.getByte2(pc + 2));
                                pc += 4;
                                break;
                            case CodeAttribute.ILOAD:
                                load(ca.getIndex2(pc), CodeAttribute.T_INT);
                                pc += 2;
                                break;
                            case CodeAttribute.LLOAD:
                                load(ca.getIndex2(pc), CodeAttribute.T_LONG);
                                pc += 2;
                                break;
                            case CodeAttribute.FLOAD:
                                load(ca.getIndex2(pc), CodeAttribute.T_FLOAT);
                                pc += 2;
                                break;
                            case CodeAttribute.DLOAD:
                                load(ca.getIndex2(pc), CodeAttribute.T_DOUBLE);
                                pc += 2;
                                break;
                            case CodeAttribute.ALOAD:
                                load(ca.getIndex2(pc), CodeAttribute.T_ADDRESS);
                                pc += 2;
                                break;
                            case CodeAttribute.ISTORE:
                                store(ca.getIndex2(pc), CodeAttribute.T_INT);
                                pc += 2;
                                break;
                            case CodeAttribute.LSTORE:
                                store2(ca.getIndex2(pc), CodeAttribute.T_LONG);
                                pc += 2;
                                break;
                            case CodeAttribute.FSTORE:
                                store(ca.getIndex2(pc), CodeAttribute.T_FLOAT);
                                pc += 2;
                                break;
                            case CodeAttribute.DSTORE:
                                store2(ca.getIndex2(pc), CodeAttribute.T_DOUBLE);
                                pc += 2;
                                break;
                            case CodeAttribute.ASTORE:
                                store(ca.getIndex2(pc), CodeAttribute.T_ADDRESS);
                                pc += 2;
                                break;
                            default:
